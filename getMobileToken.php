		...
		<div class="sidebar d-mb-none" id="side_nav">
			...
			<ul class="list-unstyled px-5 py-3">
				...
				<li><a class="text-decoration-none text-white d-block text-center py-2"
						onclick="loadView('parents_attendance')"><i class="fa-solid fa-clipboard-user"></i> View
						Attendance</a></li>
				<hr class="h-color mx-4">
				<li><a class="text-decoration-none text-white d-block text-center py-2"
						onclick="loadView('parents_notification')"><i class="fa-solid fa-bell"></i> Notification Tab</a>
				</li>
				<hr class="h-color mx-4">
				<li><a class="text-decoration-none text-white d-block text-center py-2"
						onclick="loadView('parents_change_password')"><i class="fa-solid fa-key"></i> Change
						Password</a></li>
			</ul>
				...
				<div class="container-fluid">
					<div class="navbar-brand d-flex justify-content-between d-block "
						...
						<div class="text-white">
							...
							<h4 id="getUID">Sarmiento Campus</h4>
						</div>
					</div>
				</div>
			</nav>
