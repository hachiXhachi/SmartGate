...
<body id="background-image-dashboard">
  <div class="main-container d-flex" style="font-family: sans-seriff;">
    <div class="sidebar d-mb-none" id="side_nav">
      ...
      <li class="active"><a class="text-decoration-none text-white d-block text-center py-2" onclick="loadView('parents_home')"><i class="fa-solid fa-house"></i> Home</a></li>
        <hr class="h-color mx-4">
        <li><a class="text-decoration-none text-white d-block text-center py-2" onclick="loadView('parents_attendance')"><i class="fa-solid fa-clipboard-user"></i> View Attendance</a></li>
        <hr class="h-color mx-4">
        <li><a class="text-decoration-none text-white d-block text-center py-2" onclick="loadView('parents_notification')"><i class="fa-solid fa-bell"></i> Notification Tab</a></li>
        <hr class="h-color mx-4">
